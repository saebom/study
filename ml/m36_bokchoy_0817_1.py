...
all_input_list = sorted(glob.glob('C:/study/_data/bokchoy/train_input/*.csv'))
all_target_list = sorted(glob.glob('C:/study/_data/bokchoy/train_target/*.csv'))
...
test_input_list = sorted(glob.glob('C:/study/_data/bokchoy/test_input/*.csv'))
test_target_list = sorted(glob.glob('C:/study/_data/bokchoy/test_target/*.csv'))
