...
#=================================== 결과 =====================================#
# 최상의 매개변수 :  {'colsample_bylevel': 0.7, 'colsample_bynode': 0.7, 
# 'colsample_bytree': 1, 'gamma': 0, 'learning_rate': 0.3, 'max_depth': 5, 
# 'min_child_weight': 1, 'n_estimators': 200, 'reg_alpha': 0, 'reg_lambda': 0.1, 'subsample': 0.7}
