...
model = make_pipeline(MinMaxScaler(), StandardScaler(), RandomForestClassifier())    # scaler 두 개 적용 가능함
model = make_pipeline(MinMaxScaler(), PCA(), RandomForestClassifier())    # 스케일 -> PCA로 컬럼 압축 -> RandomForestClassifier로 훈련
...
#=================== StandardScaler(), RandomForestClassifier() 적용 ====================#
# model.score :  1.0
# accuracy_score :  1.0
