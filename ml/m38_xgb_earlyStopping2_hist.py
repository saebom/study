...
plt.suptitle('validation_hist',fontsize=20)
plt.subplot(1, 2, 1)
plt.plot(hist["validation_0"]["error"], color='orange')
plt.xlabel("Validation_0")
plt.ylabel("error")

plt.subplot(1, 2, 2)
plt.plot(hist["validation_1"]["error"], color='purple')
plt.xlabel("Validation_1")
plt.ylabel("error")

# 한번에 보기
# plt.figure(figsize=(10, 8))
# plt.title('validation_hist',fontsize=20)
# plt.plot(hist["validation_0"]["error"], color='orange')
# plt.plot(hist["validation_1"]["error"], color='purple')
# plt.xlabel("Validation_0")
# plt.ylabel("error")
