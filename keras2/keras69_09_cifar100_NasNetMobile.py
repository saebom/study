...
from keras.applications import DenseNet121, MobileNetV2, NASNetMobile
import warnings
...
nasn = NASNetMobile(weights='imagenet', include_top=False)(input)
gap = GlobalAveragePooling2D()(nasn)
