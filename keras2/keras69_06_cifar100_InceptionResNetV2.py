...
icprnv2 = InceptionResNetV2(weights='imagenet', include_top=False)(input)
gap = GlobalAveragePooling2D()(icprnv2)
...
# ====================================== #
# ValueError: Exception encountered when calling layer "conv2d_75" "f"(type Conv2D):
