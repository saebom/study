...
icp = InceptionV3(weights='imagenet', include_top=False)(input)
gap = GlobalAveragePooling2D()(icp)
...
# ====================================== #
# ValueError: Exception encountered when Call arguments received by layer "conv2d_29" "f"(type Conv2D):
