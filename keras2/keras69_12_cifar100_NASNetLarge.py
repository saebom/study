...
efnb0 = NASNetLarge(weights='imagenet', include_top=False)(input)
...
# ====================================== #
# ValueError: Layer count mismatch when loading weights from file. Model expected 526 layers, found 532 saved layers.
