...
x_test = np.array([10, 1.4])
print(x.shape, y.shape, x_test.shape) # (2, 10) (10,) (2,)
...
print(x.shape, y.shape, x_test.shape) # torch.Size([10, 2]) torch.Size([10, 1]) torch.Size([2, 1])
...
print("[10, 1.4]의 예측값 : ", results.item())

# 최종 loss :  0.025031670928001404
# [10, 1.4]의 예측값 :  20.21415138244629