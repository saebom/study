...
w1 = tf.compat.v1.Variable(tf.zeros([13, 32]), name='weight1') 
...
w4 = tf.compat.v1.Variable(tf.zeros([128, 128]), name='weight4') 
b4 = tf.compat.v1.Variable(tf.zeros([128]), name='bias4')   
...
print('r2 : ', r2)      # r2 :  -0.01998832741409262

mae = mean_absolute_error(y_test, y_predict)
print('mae : ', mae)    # mae :  6.492350798962162
