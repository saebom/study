...
# model.save("./_save/keras23_17_save_model1.h5")
# model.save_weights("./_save/keras23_17_save_weights1.h5")

# model = load_model("./_save/keras23_17_save_model1.h5")
# model.load_weights('./_save/keras23_17_save_weights1.h5')
model.load_weights('./_save/keras23_17_save_weights2.h5')
...
# model.save("./_save/keras23_17_save_model2.h5")
# model.save_weights("./_save/keras23_17_save_weights2.h5")

# model = load_model("./_save/keras23_17_save_model2.h5")
...
# loss :  [18228.734375, 826372288.0]
# R2 :  0.9074473282477021
#=================================================================================#

#===================== save_model2 (훈련한 모델) ==================================#
# loss :  [18417.3203125, 876623040.0]
# R2 :  0.9018192818651805
#=================================================================================#

#===================== save_weights1 (random 한 가중치 값) ========================#
# loss :  [191731.53125, 45689651200.0]
# R2 :  -4.117184971221066
#=================================================================================#
