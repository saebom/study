...
dense1 = Conv2D(filters=32, kernel_size=(3, 3), # padding='same', 
                 activation='relu')(input1)
dense2 = MaxPooling2D(2, 2)(dense1)  
dense3 = Dropout(0.2)(dense2)     
dense4 = Conv2D(32, (3, 3), padding='same', activation='relu')(dense3)                
dense5 = MaxPooling2D(2, 2)(dense4)  
dense6 = Dropout(0.2)(dense5)     
dense7 = Conv2D(64, (3, 3), padding='same', activation='relu')(dense6)
dense8 = MaxPooling2D(2, 2)(dense7)     
dense9 = Dropout(0.2)(dense8)
dense10 = Conv2D(64, (3, 3), padding='same', activation='relu')(dense9)
dense11 = MaxPooling2D(2, 2)(dense10)
dense12 = Dropout(0.2)(dense11)
dense13 = Conv2D(128, (3, 3), padding='same', activation='relu')(dense12)
             
dense14 = Flatten()(dense13)   
dense15 = Dense(128, activation='relu')(dense14)
dense16 = Dropout(0.2)(dense15)
output1 = Dense(10, activation='softmax')(dense16)
...
#=============================== 함수형 결과값 ===================================#
# loss :  0.6499662399291992
# accuracy :  0.7784000039100647
#================================================================================#
