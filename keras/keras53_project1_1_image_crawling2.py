...
#img 다운_폴더지정 또는 생성
img_folder_path = 'D:/study_data/_project1/img/2020SS/london/christorpher_kane/'   #이미지 저장 폴더
if not os.path.isdir(img_folder_path):
    os.mkdir(img_folder_path)
    
    
#vogue.com 접속
site_path = "https://www.vogue.com/fashion-shows/spring-2020-ready-to-wear/christorpher_kane#gallery-collection"
