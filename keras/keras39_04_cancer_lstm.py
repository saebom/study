...
model.add(LSTM(100, return_sequences=True, 
               activation='linear', input_shape=(30,1)))    # 기본 activation의 default 값은 'linear'
...
model.summary()                                                 # **** 이진 분류모델의 경우 반올림하여 0과 1로 결과값을 받음
...
#================================== RNN 모델 =====================================#
# loss :  loss :  [0.29232922196388245, 0.08656051754951477]
# acc 스코어:   0.8771929824561403
#=================================================================================#
