...
np.save('d:/study_data/_save/_npy/keras47_3_train_x.npy', arr=train_generator[0][0])
np.save('d:/study_data/_save/_npy/keras47_3_train_y.npy', arr=train_generator[0][1])
np.save('d:/study_data/_save/_npy/keras47_3_test_x.npy', arr=validation_generator[0][0])
np.save('d:/study_data/_save/_npy/keras47_3_test_y.npy', arr=validation_generator[0][1])
